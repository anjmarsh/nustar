...
;    ADD_FLARE4
;PURPOSE: 
;   Add a simulated 4MK flare, scaled by arbitrary amount, to
...
function add_flare4, imcube, frame, scale=scale, pix_size=pix_size,$
move=move, erange=erange

bkg_cts = total(imcube[*,*,frame])

;* Read in simulated flare fits file*;
f = mrdfits('/home/andrew/nusim/Solar/flare_sim_4MK_1s.events.fits',1,fh)
