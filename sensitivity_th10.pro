...
;   image cube. Simulated 10MK flare is added to input image cube, then
...
function sensitivity_th10, ima, frame=frame
...
si = 0.1
ai = add_flare10(ima, frame, scale=si, pix_size=pix_size, erange=erange)
