...
;    ADD_FLARE7
;PURPOSE: 
;   Add a simulated 7MK flare, scaled by arbitrary amount, to
...
common flare7, flare_dir, flare7

if n_elements(flare7) eq 0 then begin
...
a = where(flare7.module eq 1)   ;Events from 1 telescope (FPMA)
fa = flare7[a]
;b = where(flare7.module eq 2)   ;Events from FPMB
;fb = flare7[b]
